...
static void application_thread(void *arg1, void *arg2, void *arg3)
{
	...
	gp_rpmsg_dev_inst = rpmsg_lite_master_init(shared_memory, SHM_MEM_SIZE, RPMSG_LITE_LINK_ID, RL_NO_FLAGS, &g_rpmsg_ctxt);
    ...
    g_msg.DATA = 0U;
    (void)rpmsg_lite_send(gp_rpmsg_dev_inst, gp_rpmsg_ept, REMOTE_EPT_ADDR, (char *)&g_msg, sizeof(THE_MESSAGE), RL_DONT_BLOCK);
